...
for Part_ind = 1:4
    for Alg_ind = 1:length(Alg_Path)
        ...
        for Fold = 1:3
            ...
            savefig(string(Path_save, update_form, " - LogL Series, Fold ", string(Fold), ", Part", string(Part_ind), ".pdf" ))
            close(fig)
            # ------------------------------------------------------------------------------
            # V_Cat
        ...
        Path = string(Path_save, update_form, "_BestParams", "_Part", string(Part_ind), ".csv" )
