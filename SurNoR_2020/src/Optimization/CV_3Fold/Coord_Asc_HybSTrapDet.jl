...
for update_form = ["VarSMiLe"]
        ...
        for Chain = 1:2
            for Fold = 1:3
                    ...
                    Param_Seq = zeros(T_Iter, 19)                                                                            # WARNING: SHOULD CHANGE
                    ...
                    Param_Seq[1,19] = rand(10:100)[1]                  # C_thresh
                    ...
                    Param1.C_thresh = Param_Seq[1,19]
                    ...
                    while (t<=T_Iter)&&Flag
                            ...
                            Param_perm_order = shuffle(1:19)                                                                    # WARNING: SHOULD CHANGE
                            ...
                            if (t==T_Iter)||(mod(t,5)==0)||(!Flag)                                                              # WARNING: SHOULD CHANGE
                                    Path = string("src/Optimization/CV_3Fold/CoAscData_HybSTrapDet_F", string(Fold), "_C",
                                                    string(Chain), ".csv")
