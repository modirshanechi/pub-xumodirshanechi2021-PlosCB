...
# ------------------------------------------------------------------------------
Inputs = load("data/Simulated_data/Simulated_data.jld")Inputs = Inputs["Inputs"]
N = 12
N_start = (n_set-1)*N
            ...
            @distributed for Fold = 1:3
                    ...
                    while (t<=T_Iter)&&Flag
                            ...
                            if (t==T_Iter)||(mod(t,5)==0)||(!Flag)                                                              # WARNING: SHOULD CHANGE
                                    Path = string("src/Optimization_Simulated_Data/CV_3Fold/CoAscData_SurNoR_nset_", string(n_set),
                                                  "_F", string(Fold), "_C", string(Chain), ".csv")
