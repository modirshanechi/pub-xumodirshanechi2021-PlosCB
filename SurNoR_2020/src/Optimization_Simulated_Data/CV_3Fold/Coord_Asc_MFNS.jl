...
for update_form = ["VarSMiLe"]
        ...
        for Chain = 1:100
            @distributed for Fold = 1:3
                    ...
                    Param_Seq = zeros(T_Iter, 13)                                                                            # WARNING: SHOULD CHANGE
                    ...
                    Param_Seq[1,13] = rand(Rayleigh(5) ,1)[1]          # β_R_2
                    ...
                    while (t<=T_Iter)&&Flag
                            ...
                            Param_perm_order = shuffle(1:13)                                                                    # WARNING: SHOULD CHANGE
                            ...
                            if (t==T_Iter)||(mod(t,5)==0)||(!Flag)                                                              # WARNING: SHOULD CHANGE
                                    Path = string("src/Optimization_Simulated_Data/CV_3Fold/CoAscData_MFNS_nset_", string(n_set),
                                                  "_F", string(Fold), "_C",
                                                  string(Chain), ".csv")
